...
//           if (data["message"] !== "Profile ID is required") {
...
//         id="container"
//         onClick={handleOnClose}
//         className="inset-0 bg-black bg-opacity-30 backdrop-blur-sm flex justify-center items-center"
//       >
//         <div className="info-modal bg-white rounded w-72 text-gray-700 p-2">
//           <div className="flex m-2">
//             <div className="top w-full flex justify-between align-center">
...
//                         id="number"
//                         type="text"
//                         onChange={(e) => setWeight(Math.max(e.target.value, 0))}
//                       />
//                     </div>
//                   </div>
//                 </div>
...
//                         id="wins"
//                         type="number"
//                         onChange={(e) => setWins(Math.max(e.target.value, 0))}
//                       />
//                     </div>
//                     <div className="w-full md:w-1/2 pl-3">
//                       <label
...
//                         id="losses"
//                         type="number"
//                         onChange={(e) => setLosses(Math.max(e.target.value, 0))}
//                       />
//                     </div>
//                     <div className="w-full md:w-1/2 pl-3">
//                       <label
...
//                         id="losses"
//                         type="number"
//                         onChange={(e) => setKOs(Math.max(e.target.value, 0))}
//                       />
//                     </div>
//                     <div className="w-full md:w-1/2 pl-3">
//                       <label
...
//                         type="number"
//                         onChange={(e) =>
//                           setTotalFights(Math.max(e.target.value, 0))
//                         }
//                       />
//                     </div>
//                   </div>
...
//                         id="last-name"
//                         type="number"
//                         onChange={(e) => setAge(Math.max(e.target.value, 0))}
//                       />
//                     </div>
//                   </div>
//                 </div>
