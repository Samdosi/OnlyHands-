...
const Rules = ({setBgImage}) => {
  ...
  return (
    <div className='bg-gradient-to-l from-[#323232] to-black text-center w-3/6 p-6 absolute top-1/2 left-1/2 -translate-x-2/4 -translate-y-2/4 rounded text-white'>
      <h1 className='font-semibold text-4xl m-7'>RULES</h1>
